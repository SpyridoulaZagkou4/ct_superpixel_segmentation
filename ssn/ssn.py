...
def ssn_iter(pixel_features, num_spixels, n_iter):
    ...
    """
    height, width = pixel_features.shape[-2:]
    num_spixels_width = int(math.sqrt(num_spixels * width / height))     # num_spixels_width = 10
    num_spixels_height = int(math.sqrt(num_spixels * height / width))
    # print("O arithmos twn superpixel width einai: %d" %num_spixels_width)
    ...
    for _ in range(n_iter):
        ...
        # ---------------------- torch function ------------------------------------------
        # [1, 20, 1]
        new_dist_matrix= torch.cdist(pixel_features,init_label_map)
        # ----------------------- DEBUG ---------------------------------------------------
        # print(dist_matrix)
        # print(dist_matrix.size())      # [1, 9, 40000]
        # print(new_dist_matrix)
        # print(new_dist_matrix.size())  # [1, 20, 1]
        ...
        # -----------------------------------------
        # print(abs_indices[:, mask].size())
        # print(reshaped_affinity_matrix[mask].size())
        #
        # print(abs_indices.size())
        # print(reshaped_affinity_matrix.size())
        #
        # print(sparse_abs_affinity.size())
        # print(abs_affinity.size())
        #
        # print(pixel_features.size())
        # print(permuted_pixel_features.size())
        # -----------------------------------------
